    ...
    <div class="widget-content">
      ...
      <ul class="list-unstyled">
        ...
        <?php foreach ( $news as $index => $new ) : ?>
          ...
          <li data-id="<?php echo $index; ?>" data-title="<?php echo $new['title']; ?>">

            <div class="row">

              <div class="col-xs-4">

                <a class="show-article" href="#">

                  <img alt="<?php echo $new['title']; ?>" class="img-responsive" height="200" src="<?php echo $new['thumb']; ?>" width="200">
              ...
              <div class="col-sm-8">
                ...
                <div class="vc-wrapper">
                  ...
                  <h2><a class="show-article" href="#"><?php echo $new['title']; ?></a></h2>

                  <p>posted <?php echo $helper->datetime_ago( $new['created_at'] ); ?></p>
